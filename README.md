...
Generative AI was utilized to help build the code to implement the kinematics for this program. The code in the functions compute_displacement and calculate_adjustments were written by GAI tools following the guidelines of the kinematics and equations I used to determine the effect of the wind vectors on the golf ball.
